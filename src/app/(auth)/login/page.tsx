...
function LoginFallback() {
  return (
    <div className="bg-card border border-border rounded-2xl p-8 shadow-sm flex items-center justify-center">
...
function LoginForm() {
  ...
  async function handleGoogleLogin() {
    if (!googleAuthEnabled) {
      toast.error("Google sign-in is not enabled for this app.");
      return;
    }
    ...
    >
      ...
      {googleAuthEnabled && (
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-lg border border-border bg-background hover:bg-muted transition-colors px-4 py-2.5 text-sm font-medium disabled:opacity-60"
        >
          {googleLoading ? (
      ...
      <form onSubmit={handleEmailLogin} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 bg-primary text-primary-foreground rounded-lg px-4 py-2.5 text-sm font-semibold hover:bg-primary/90 transition-colors disabled:opacity-60"
        >
